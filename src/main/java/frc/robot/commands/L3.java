...
public class L3 extends Command {
     ...
     */
    public L3(Elevator elevator, AlgaeMech algaeMech, Supplier<Boolean> clutch, CommandPS4Controller controller) {
        m_elevator = elevator;
    ...
    public void initialize() {
        controller.povUp().onTrue(Commands.runOnce(() -> m_elevator.increaseL3Offset(500)));
        controller.povDown().onTrue(Commands.runOnce(() -> m_elevator.increaseL3Offset(-500)));
    }
